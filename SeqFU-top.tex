...
\begin{enumerate}
    ...
    \item Under which set theoretic assumptions do such examples exist? Look at the paper by Nyikos: Subsets of \(^\omega \omega\) and the Fréchet Urysohn and \(\alpha_i\) properties. \textcolor{red}{Good grasp at sections 1, 2, 5, 6; partial understanding section 3; skipped section 4}.
    ...
    \begin{itemize}
        ...
        \item if 1st countable then \(\alpha_1\)
